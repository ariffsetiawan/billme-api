...
var user2 = router.route('/user/:user_id');
...
------------------------------------------------------*/
user2.all(function(req,res,next){
    console.log("You need to smth about user2 Route ? Do it here");
    console.log(req.params);
    next();
});

//get data to update
user2.get(function(req,res,next){
...
//update data
user2.put(function(req,res,next){
    var user_id = req.params.user_id;
...
//delete data
user2.delete(function(req,res,next){
